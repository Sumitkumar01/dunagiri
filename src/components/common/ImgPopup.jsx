...
function ImgPopup({ data, setShow }) {
  ...
  return (
    <section
      className="flex items-center justify-center fixed top-0 left-0 z-50 w-full h-full bg-white"
      id="popup"
    >
      <div className="flex flex-col w-[80%] justify-start gap-16 h-[90%]">
        <div className="flex justify-between items-center">
          <button className="" onClick={zoom}>
            {click ? (
              ...
              <Image src={zoomin} alt="button-zoomin" width="50" height="50" />
            )}
          </button>
        ...
        <div className="w-full flex justify-center">
          <div className="lg:flex justify-between items-start gap-5 w-max">
